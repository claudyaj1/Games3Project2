...
namespace BoundingVolumeRendering
{
    ...
    public static class BoundingSphereRenderer
    {
        ...
        /// <param name="sphereResolution">Default: 45, The number of line segments to use for each of the three circles.</param>
        public static void Initialize(GraphicsDevice graphicsDevice, int sphereResolution)
        {
            if (sphereResolution <= 0) throw new ArgumentOutOfRangeException();
